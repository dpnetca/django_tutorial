    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(help_text="12 Character <a href='https://www.isbn-international.org/content/what-isbn'>ISBN number</a>", max_length=13, verbose_name='ISBN')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('m', 'Maintenance'), ('o', 'On Load'), ('a', 'Available'), ('r', 'Reservered')], default='m', help_text='Book availability', max_length=1)),
